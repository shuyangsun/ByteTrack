...
# Run model
$ python tools/demo_track.py video -f exps/example/mot/yolox_x_ablation.py -c ${PATH_TO_BTRACK_MODEL} --fps 15 --fp16 --batch_size 64 --fuse --save_result --save_media --path /path/to/file.mp4
...
$ python tools/demo_track.py video -f exps/example/mot/yolox_x_ablation.py -c ${PATH_TO_BTRACK_TRT_ENGINE} --fps 15 --fp16 --batch_size 64 --trt --save_result --save_media --path /path/to/file.mp4
